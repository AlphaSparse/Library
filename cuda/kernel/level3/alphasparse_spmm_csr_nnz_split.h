                ...
                void* externalBuffer)
{
  ...
  if (align) {
    if (warp_size == 32 && factor == 4) {
      csrspmm_nnz_split_aligned_kernel_v2<block_size, 32, 32, T, U, V, W, 4, 8, ORDER_ROW>
        <<<gridDim, blockDim, 0, handle->stream>>>(
          M, N, K, nnz, alpha,
          csr_row_ptr, csr_col_ind, csr_val, matB, ldb,
          beta, matC, ldc,
    ...
    if (warp_size == 32 && factor == 2) {
      csrspmm_nnz_split_aligned_kernel_v2<block_size, 32, 32, T, U, V, W, 2, 8, ORDER_ROW>
        <<<gridDim, blockDim, 0, handle->stream>>>(
          M, N, K, nnz, alpha,
          csr_row_ptr, csr_col_ind, csr_val, matB, ldb,
          beta, matC, ldc,
    ...
    if (warp_size == 16 && factor == 2) {
      csrspmm_nnz_split_aligned_kernel_v2<block_size, 16, 16, T, U, V, W, 2, 8, ORDER_ROW>
        <<<gridDim, blockDim, 0, handle->stream>>>(
          M, N, K, nnz, alpha,
          csr_row_ptr, csr_col_ind, csr_val, matB, ldb,
          beta, matC, ldc,
    ...
    if (warp_size == 32 && factor == 4) {
      csrspmm_nnz_split_nonaligned_kernel_v2<block_size, 32, 32, T, U, V, W, 4, 8, ORDER_ROW>
        <<<gridDim, blockDim, 0, handle->stream>>>(
          M, N, K, nnz, alpha,
          csr_row_ptr, csr_col_ind, csr_val, matB, ldb,
          beta, matC, ldc,
    ...
    if (warp_size == 32 && factor == 2) {
      csrspmm_nnz_split_nonaligned_kernel_v2<block_size, 32, 32, T, U, V, W, 2, 8, ORDER_ROW>
        <<<gridDim, blockDim, 0, handle->stream>>>(
          M, N, K, nnz, alpha,
          csr_row_ptr, csr_col_ind, csr_val, matB, ldb,
          beta, matC, ldc,
    ...
    if (warp_size == 16 && factor == 2) {
      csrspmm_nnz_split_nonaligned_kernel_v2<block_size, 16, 16, T, U, V, W, 2, 8, ORDER_ROW>
        <<<gridDim, blockDim, 0, handle->stream>>>(
          M, N, K, nnz, alpha,
          csr_row_ptr, csr_col_ind, csr_val, matB, ldb,
          beta, matC, ldc,
