...
template <typename J>
alphasparseStatus_t diagmm_bsr_u_row_plain(const J alpha, const internal_spmat mat, const J *x, const ALPHA_INT columns, const ALPHA_INT ldx, const J beta, J *y, const ALPHA_INT ldy)
{
    ALPHA_INT rowC = mat->rows * mat->block_dim;
    ALPHA_INT colC = columns;

    for (ALPHA_INT r = 0; r < rowC; ++r) //������ʱ���col�����෴
    {
