...
template <typename J>
alphasparseStatus_t hermm_bsr_n_hi_col_trans_plain(const J alpha, const internal_spmat mat, const J *x, const ALPHA_INT columns, const ALPHA_INT ldx, const J beta, J *y, const ALPHA_INT ldy)
{
