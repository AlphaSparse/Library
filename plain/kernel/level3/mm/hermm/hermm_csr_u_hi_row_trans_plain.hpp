...
template <typename J>
alphasparseStatus_t hermm_csr_u_hi_row_trans_plain(const J alpha, const internal_spmat mat, const J *x, const ALPHA_INT columns, const ALPHA_INT ldx, const J beta, J *y, const ALPHA_INT ldy)
{
    ...
    alphasparseStatus_t status = hermm_csr_u_lo_row_plain(alpha, transposed_mat, x, columns, ldx, beta, y, ldy);
