...
template <typename J>
alphasparseStatus_t trmm_coo_u_lo_row_plain(const J alpha, const internal_spmat mat, const J *x, const ALPHA_INT columns, const ALPHA_INT ldx, const J beta, J *y, const ALPHA_INT ldy)
{
    ALPHA_INT n = columns;
    ALPHA_INT r = 0;
