...
template <typename J>
alphasparseStatus_t trsm_coo_u_lo_col_plain(const J alpha, const internal_spmat A, const J *x, const ALPHA_INT columns, const ALPHA_INT ldx, J *y, const ALPHA_INT ldy)
{
    ALPHA_INT m = A->rows;
