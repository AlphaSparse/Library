...
template <typename J>
alphasparseStatus_t diagsm_csc_n_col_plain(const J alpha, const internal_spmat A, const J *x, const ALPHA_INT columns, const ALPHA_INT ldx, J *y, const ALPHA_INT ldy)
{//assume A is square
