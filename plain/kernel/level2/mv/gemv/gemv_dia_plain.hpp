...
alphasparseStatus_t gemv_dia_plain(const TYPE alpha,
...
template <typename TYPE>
alphasparseStatus_t gemv_dia_conj_plain(const TYPE alpha,
		               const internal_spmat A,
		               const TYPE* x,
		               const TYPE beta,
		               TYPE* y)
...
template <typename TYPE>
alphasparseStatus_t gemv_dia_trans_plain(const TYPE alpha,
		               const internal_spmat A,
		               const TYPE* x,
		               const TYPE beta,
		               TYPE* y)
