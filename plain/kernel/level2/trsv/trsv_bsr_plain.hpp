...
alphasparseStatus_t trsv_bsr_n_hi_plain(const TYPE alpha, const internal_spmat A, const TYPE *x, TYPE *y)
{
...
template <typename TYPE>
alphasparseStatus_t trsv_bsr_n_lo_plain(const TYPE alpha, const internal_spmat A, const TYPE *x, TYPE *y)
{
...
template <typename TYPE>
alphasparseStatus_t trsv_bsr_u_hi_plain(const TYPE alpha, const internal_spmat A, const TYPE *x, TYPE *y)
{
    ALPHA_INT block_rowA = A->rows;
    ALPHA_INT rowA = A->rows * A->block_dim;
    ALPHA_INT bs = A->block_dim;
...
template <typename TYPE>
alphasparseStatus_t trsv_bsr_u_lo_plain(const TYPE alpha, const internal_spmat A, const TYPE *x, TYPE *y)
{
    ALPHA_INT block_rowA = A->rows;
    ALPHA_INT rowA = A->rows * A->block_dim;
    ALPHA_INT bs = A->block_dim;
