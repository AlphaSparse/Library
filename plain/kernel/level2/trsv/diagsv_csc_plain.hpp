...
alphasparseStatus_t diagsv_csc_n_plain(const TYPE alpha, const internal_spmat A, const TYPE *x, TYPE *y)
{
    TYPE diag[A->cols];
...
template <typename TYPE>
alphasparseStatus_t diagsv_csc_u_plain(const TYPE alpha, const internal_spmat A, const TYPE *x, TYPE *y)
{
