...
alphasparseStatus_t diagsv_bsr_n_plain(const TYPE alpha, const internal_spmat A, const TYPE *x, TYPE *y)
{
...
template <typename TYPE>
alphasparseStatus_t diagsv_bsr_u_plain(const TYPE alpha, const internal_spmat A, const TYPE *x, TYPE *y)
{
