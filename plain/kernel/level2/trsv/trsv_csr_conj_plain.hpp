...
template <typename J>
alphasparseStatus_t trsv_csr_n_hi_conj_plain(const J alpha, 
...
template <typename J>
alphasparseStatus_t trsv_csr_u_hi_conj_plain(const J alpha, 
                          const internal_spmat A,
                          const J *x, 
                          J *y)
{    
...
template <typename J>
alphasparseStatus_t trsv_csr_n_lo_conj_plain(const J alpha, 
                          const internal_spmat A,
                          const J *x, 
                          J *y)
{    
...
template <typename J>
alphasparseStatus_t trsv_csr_u_lo_conj_plain(const J alpha, 
                          const internal_spmat A,
                          const J *x, 
                          J *y)
{    
