...
alphasparseStatus_t trsv_dia_n_hi_plain(const TYPE alpha, const internal_spmat A, const TYPE *x, TYPE *y)
{
    TYPE diag[A->rows];
...
template <typename TYPE>
alphasparseStatus_t trsv_dia_n_lo_plain(const TYPE alpha, const internal_spmat A, const TYPE *x, TYPE *y)
{
    TYPE diag[A->rows];
    ALPHA_INT main_diag_pos = 0;
    memset(diag, '\0', A->rows * sizeof(TYPE));
...
template <typename TYPE>
alphasparseStatus_t trsv_dia_u_hi_plain(const TYPE alpha, const internal_spmat A, const TYPE *x, TYPE *y)
{
    ALPHA_INT main_diag_pos = 0;
...
template <typename TYPE>
alphasparseStatus_t trsv_dia_u_lo_plain(const TYPE alpha, const internal_spmat A, const TYPE *x, TYPE *y)
{
    ALPHA_INT main_diag_pos = 0;
