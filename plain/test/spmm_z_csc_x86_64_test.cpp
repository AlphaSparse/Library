...
static sparse_status_t alpha_convert_mkl_csc_c(alphasparse_matrix_t src,
  ...
  sparse_status_t st = mkl_sparse_z_create_csc(
      ...
      mat->cols_end, mat->row_indx, (MKL_Complex16 *)mat->values);
  return st;
}
...
static void mkl_spmm(const int argc, const char *argv[], const char *file,
  ...
  // nnz, row_index, col_index, values), "mkl_sparse_z_create_coo"); if(transA
  ...
  mkl_call_exit(mkl_sparse_z_export_csc(result, ret_index, ret_rows, ret_cols,
...
// **ret_col_index, ALPHA_Complex16 **ret_values)
static void alpha_spmm(const int argc, const char *argv[], const char *file,
  ...
  alpha_call_exit(alphasparse_z_export_csc(result, ret_index, ret_rows, ret_cols,
                                        ret_rows_start, ret_rows_end,
                                        ret_col_index, ret_values),
