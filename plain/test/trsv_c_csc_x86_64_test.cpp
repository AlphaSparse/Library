...
static void mkl_trsv(const int argc, const char *argv[], const char *file,
  ...
  // mkl_sparse_c_create_coo(&cooA, SPARSE_INDEX_BASE_ZERO, m, k, nnz,
  ...
  mkl_call_exit(mkl_sparse_c_trsv(transA, alpha, cscA, descr, x, y),
                "mkl_sparse_c_trsv");
...
static void alpha_trsv(const int argc, const char *argv[], const char *file,
                     ...
                     ALPHA_Complex8 **ret_x, size_t *ret_size_x) {
  ALPHA_INT m, k, nnz;
