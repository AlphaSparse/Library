...
static void mkl_spmm(const int argc, const char *argv[], const char *file,
                     ...
                     MKL_INT **ret_col_index, MKL_Complex8 **ret_values) {
  MKL_INT m, k, nnz;
  ...
  mkl_call_exit(
      mkl_sparse_c_export_bsr(result, ret_index, &mkl_block_layout, ret_rows,
...
static void alpha_spmm(const int argc, const char *argv[], const char *file,
                     ...
                     ALPHA_INT **ret_col_index, ALPHA_Complex8 **ret_values,
                     int flag) {
  ALPHA_INT m, k, nnz;
  ...
  alpha_call_exit(
      alphasparse_c_export_bsr(result, ret_index, &alpha_block_layout, ret_rows,
...
int main(int argc, const char *argv[]) {
  ...
  */
  ...
  if (check) {
    ...
    // status = check_s((float *)mkl_values, 2*mkl_nnz*BLOCK_SIZE*BLOCK_SIZE,
    // (float *)alpha_values, 2*alpha_nnz*BLOCK_SIZE*BLOCK_SIZE);
  }
