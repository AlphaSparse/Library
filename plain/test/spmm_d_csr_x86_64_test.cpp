...
static void mkl_spmm(const int argc, const char *argv[], const char *file,
  ...
  mkl_call_exit(mkl_sparse_d_create_coo(&coo, SPARSE_INDEX_BASE_ZERO, m, k, nnz,
                ...
                "mkl_sparse_d_create_coo");
  mkl_call_exit(
      mkl_sparse_convert_csr(coo, SPARSE_OPERATION_NON_TRANSPOSE, &csrB),
      "mkl_sparse_convert_csr");

  alpha_timer_t timer;
  alpha_timing_start(&timer);

  mkl_call_exit(mkl_sparse_spmm(transA, csrA, csrB, &result),
                "mkl_sparse_spmm");
...
static void alpha_spmm(const int argc, const char *argv[], const char *file,
  ...
  alpha_call_exit(alphasparse_spmm_plain(transA, csrA, csrB, &result),
