...
static void mkl_spmm(const int argc, const char *argv[], const char *file,
                     ...
                     MKL_INT **ret_col_index, double **ret_values) {
  MKL_INT m, k, nnz;
  ...
  mkl_sparse_d_create_coo(&cooB, SPARSE_INDEX_BASE_ZERO, m, k, nnz, row_index,
                          col_index, values);
  mkl_call_exit(
  ...
  mkl_call_exit(
      mkl_sparse_d_export_bsr(result, ret_index, &mkl_block_layout, ret_rows,
...
static void alpha_spmm(const int argc, const char *argv[], const char *file,
                     ...
                     ALPHA_INT **ret_col_index, double **ret_values, int flag) {
  ALPHA_INT m, k, nnz;
  ...
  alphasparse_d_create_coo(&cooB, ALPHA_SPARSE_INDEX_BASE_ZERO, m, k, nnz,
                          row_index, col_index, values);
  alpha_call_exit(
  ...
  alpha_call_exit(
      alphasparse_d_export_bsr(result, ret_index, &alpha_block_layout, ret_rows,
...
int main(int argc, const char *argv[]) {
  ...
  */
  ...
  if (check) {
    ...
    // status = check_d((double *)mkl_values, mkl_nnz*BLOCK_SIZE*BLOCK_SIZE,
    // (double *)alpha_values, alpha_nnz*BLOCK_SIZE*BLOCK_SIZE);
  }
