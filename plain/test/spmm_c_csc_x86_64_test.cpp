...
static void mkl_spmm(const int argc, const char *argv[], const char *file,
  ...
  // nnz, row_index, col_index, values), "mkl_sparse_c_create_coo"); if(transA
  ...
  mkl_call_exit(mkl_sparse_c_export_csc(result, ret_index, ret_rows, ret_cols,
...
// **ret_col_index, ALPHA_Complex8 **ret_values)
static void alpha_spmm(const int argc, const char *argv[], const char *file,
  ...
  alpha_call_exit(alphasparse_c_export_csc(result, ret_index, ret_rows, ret_cols,
                                        ret_rows_start, ret_rows_end,
                                        ret_col_index, ret_values),
...
int main(int argc, const char *argv[]) {
  ...
  if (check) {
    ...
    status = check_c_l3((ALPHA_Complex8 *)mkl_values, 0, mkl_nnz, alpha_values, 0,
                        alpha_nnz, col_index, NULL, 0, alpha_values, 0, zero, zero,
                        argc, argv);
  }
