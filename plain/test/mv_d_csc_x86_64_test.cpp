...
// thread_num, const double alpha, const double beta, double **ret_y, size_t
// *ret_size_y)
static void alpha_mv(const int argc, const char *argv[], const char *file,
  ...
  alpha_call_exit(alphasparse_d_mv_plain(transA, alpha, cscA, descr, x, beta, y),
                "alphasparse_d_mv");
...
int main(int argc, const char *argv[]) {
  ...
  if (check) {
    ...
    // size_alpha_y * 2); status = check_d_l2((double *)mkl_y, size_mkl_y, alpha_y,
